...
namespace AccesoDatos
{
    public class ClienteDA
    {
        ...
        public BindingList<Cliente> listarClientesVendedor(string dniVendedor)
        {
            try
            {
                BindingList<Cliente> clientes = new BindingList<Cliente>();
                ...
                MySqlCommand cmd = new MySqlCommand();
                String sql = "select * from n_cliente c,n_usuarios u where  c.dni_vendedor=u.dni_empleado and c.estado='ACTIVO' and c.dni_vendedor='" + dniVendedor.ToString() + "'";
                cmd.CommandText = sql;
                cmd.Connection = conn;
                MySqlDataReader reader = cmd.ExecuteReader();
